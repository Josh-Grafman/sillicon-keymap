...
#define DUAL_FUNC_2 LT(9, KC_J)
#define DUAL_FUNC_3 LT(9, KC_F4)
#define DUAL_FUNC_4 LT(2, KC_F17)
#define DUAL_FUNC_5 LT(3, KC_H)
#define DUAL_FUNC_6 LT(13, KC_F22)
#define DUAL_FUNC_7 LT(4, KC_A)
#define DUAL_FUNC_8 LT(3, KC_F15)
#define DUAL_FUNC_9 LT(12, KC_L)
#define DUAL_FUNC_10 LT(15, KC_F22)
#define DUAL_FUNC_11 LT(11, KC_N)
#define DUAL_FUNC_12 LT(12, KC_1)
#define DUAL_FUNC_13 LT(6, KC_Y)
#define DUAL_FUNC_14 LT(1, KC_X)
#define DUAL_FUNC_15 LT(1, KC_F17)
#define DUAL_FUNC_16 LT(1, KC_F13)
#define DUAL_FUNC_17 LT(3, KC_X)
