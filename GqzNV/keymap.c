...
#define DUAL_FUNC_4 LT(2, KC_H)
#define DUAL_FUNC_5 LT(9, KC_Q)
#define DUAL_FUNC_6 LT(7, KC_6)
#define DUAL_FUNC_7 LT(11, KC_F2)
#define DUAL_FUNC_8 LT(4, KC_8)
#define DUAL_FUNC_9 LT(8, KC_V)
#define DUAL_FUNC_10 LT(5, KC_N)
#define DUAL_FUNC_11 LT(14, KC_S)
#define DUAL_FUNC_12 LT(11, KC_F24)
#define DUAL_FUNC_13 LT(7, KC_1)
#define DUAL_FUNC_14 LT(6, KC_F20)
#define DUAL_FUNC_15 LT(6, KC_7)
#define DUAL_FUNC_16 LT(2, KC_T)
#define DUAL_FUNC_17 LT(2, KC_U)
